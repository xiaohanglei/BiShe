/****************************************************************************
** Meta object code from reading C++ file 'deal.hpp'
**
...
#error "The header file 'deal.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 5, 8), // "newPaper"
QT_MOC_LITERAL(2, 14, 0), // ""
QT_MOC_LITERAL(3, 15, 4) // "name"

    },
    "Deal\0newPaper\0\0name"
};
...
void Deal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (Deal::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Deal::newPaper)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Deal::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Deal.data,
      qt_meta_data_Deal,  qt_static_metacall, nullptr, nullptr}
};
...
void *Deal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Deal.stringdata0))
        return static_cast<void*>(const_cast< Deal*>(this));
...
// SIGNAL 0
void Deal::newPaper(const QString & _t1)
{
